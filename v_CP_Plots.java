...
public class v_CP_Plots extends StarMacro {
  ...
  private void execute0() {
    ...
    userFieldFunction_0.setDefinition("${Pressure}/(0.5*1.225*pow(${Car-Velocity},2))");   
    ...
    hardcopyProperties_0.setOutputWidth(1920);

    hardcopyProperties_0.setOutputHeight(1080);

    xYPlot_0.setTitle("CP_FW - y = 1 mm");

    new File(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Scenes")).mkdirs();

    xYPlot_0.encode(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Images\\CP_FW - 0 - y = 1 mm.png"), "png", 1920, 1080);

    xYPlot_0.exportScene(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Scenes\\CP_FW - 0 - y = 1 mm.sce"), "CP_FW", "", false, false);

  xYPlot_0.export(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Files\\CP_FW - 0 - y = 1 mm.csv"), ",");
  ...
  xYPlot_0.encode(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Images\\CP_FW - "+ i +" - y = "+ coordinate +" mm.png"), "png", 1920, 1080);

  xYPlot_0.exportScene(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Scenes\\CP_FW - "+ i +" - y = "+ coordinate +" mm.sce"), "CP_FW", "", false, false);

  xYPlot_0.export(resolvePath("..\\Post_Processing\\CP\\FW\\Monitors\\Files\\CP_FW - "+ i +" - y = "+ coordinate +" mm.csv"), ",");
}

  PlaneSection planeSection_1 = 
      (PlaneSection) simulation_0.getPartManager().createImplicitPart(new NeoObjectVector(new Object[] {}), new DoubleVector(new double[] {0.0, 0.0, 1.0}), new DoubleVector(new double[] {0.0, 0.0, 0.0}), 0, 1, new DoubleVector(new double[] {0.0}));

    planeSection_1.setPresentationName("CP_SC");
    ...
    xYPlot_1.setPresentationName("CP_SC");

    xYPlot_1.copyProperties(xYPlot_0);

    xYPlot_1.getParts().setObjects(planeSection_1);

    xYPlot_1.setTitle("CP_SC - y = 1 mm");

    new File(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Scenes")).mkdirs();

    xYPlot_1.encode(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Images\\CP_SC - 0 - y = 255 mm.png"), "png", 1920, 1080);

    xYPlot_1.exportScene(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Scenes\\CP_SC - 0 - y = 255 mm.sce"), "CP_SC", "", false, false);

  xYPlot_1.export(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Files\\CP_SC - 0 - y = 255 mm.csv"), ",");
  ...
  xYPlot_1.setTitle("CP_SC - y = "+ coordinate +" mm");
  
  xYPlot_1.encode(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Images\\CP_SC - "+ i +" - y = "+ coordinate +" mm.png"), "png", 1920, 1080);

  xYPlot_1.exportScene(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Scenes\\CP_SC - "+ i +" - y = "+ coordinate +" mm.sce"), "CP_SC", "", false, false);

  xYPlot_1.export(resolvePath("..\\Post_Processing\\CP\\Side_Elements\\Monitors\\Files\\CP_SC - "+ i +" - y = "+ coordinate +" mm.csv"), ",");
}

PlaneSection planeSection_2 = 
      (PlaneSection) simulation_0.getPartManager().createImplicitPart(new NeoObjectVector(new Object[] {}), new DoubleVector(new double[] {0.0, 0.0, 1.0}), new DoubleVector(new double[] {0.0, 0.0, 0.0}), 0, 1, new DoubleVector(new double[] {0.0}));

    planeSection_2.setPresentationName("CP_Diff");
    ...
    xYPlot_2.setPresentationName("CP_Diff");

    xYPlot_2.copyProperties(xYPlot_0);

    xYPlot_2.getParts().setObjects(planeSection_2);

    xYPlot_2.setTitle("CP_Diff - y = 1 mm");

    new File(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Scenes")).mkdirs();

    xYPlot_2.encode(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Images\\CP_Diff - 0 - y = 1 mm.png"), "png", 1920, 1080);

    xYPlot_2.exportScene(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Scenes\\CP_Diff - 0 - y = 1 mm.sce"), "CP_Diff", "", false, false);

  xYPlot_2.export(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Files\\CP_Diff - 0 - y = 1 mm.csv"), ",");
  ...
  xYPlot_2.setTitle("CP_Diff - y = "+ coordinate +" mm");
  
  xYPlot_2.encode(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Images\\CP_Diff - "+ i +" - y = "+ coordinate +" mm.png"), "png", 1920, 1080);

  xYPlot_2.exportScene(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Scenes\\CP_Diff - "+ i +" - y = "+ coordinate +" mm.sce"), "CP_Diff", "", false, false);

  xYPlot_2.export(resolvePath("..\\Post_Processing\\CP\\Diffusers\\Monitors\\Files\\CP_Diff - "+ i +" - y = "+ coordinate +" mm.csv"), ",");
}

PlaneSection planeSection_3 = 
      (PlaneSection) simulation_0.getPartManager().createImplicitPart(new NeoObjectVector(new Object[] {}), new DoubleVector(new double[] {0.0, 0.0, 1.0}), new DoubleVector(new double[] {0.0, 0.0, 0.0}), 0, 1, new DoubleVector(new double[] {0.0}));

    planeSection_3.setPresentationName("CP_RW");
    ...
    xYPlot_3.setPresentationName("CP_RW");

    xYPlot_3.copyProperties(xYPlot_0);

    xYPlot_3.getParts().setObjects(planeSection_3);

    xYPlot_3.setTitle("CP_RW - y = 1 mm");

    new File(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Scenes")).mkdirs();

    xYPlot_3.encode(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Images\\CP_RW - 0 - y = 1 mm.png"), "png", 1920, 1080);

    xYPlot_3.exportScene(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Scenes\\CP_RW - 0 - y = 1 mm.sce"), "CP_RW", "", false, false);

  xYPlot_3.export(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Files\\CP_RW - 0 - y = 1 mm.csv"), ",");
  ...
  xYPlot_3.setTitle("CP_RW - y = "+ coordinate +" mm");
  
  xYPlot_3.encode(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Images\\CP_RW - "+ i +" - y = "+ coordinate +" mm.png"), "png", 1920, 1080);

  xYPlot_3.exportScene(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Scenes\\CP_RW - "+ i +" - y = "+ coordinate +" mm.sce"), "CP_RW", "", false, false);

  xYPlot_3.export(resolvePath("..\\Post_Processing\\CP\\RW\\Monitors\\Files\\CP_RW - "+ i +" - y = "+ coordinate +" mm.csv"), ",");
}
/*
try {
  ...
  Boundary boundary_1001 = 
    ...
    planeSection_4.setPresentationName("CP_Misc");
    ...
    xYPlot_4.setPresentationName("CP_Misc");

    xYPlot_4.copyProperties(xYPlot_0);

    xYPlot_4.getParts().setObjects(planeSection_4);

    xYPlot_4.setTitle("CP_Misc - y = "+ -max_Misc +" mm");

    new File(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Scenes")).mkdirs();

    xYPlot_4.encode(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Images\\CP_Misc - 0 - y = "+ -max_Misc +" mm.png"), "png", 1920, 1080);

    xYPlot_4.exportScene(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Scenes\\CP_Misc - 0 - y = "+ -max_Misc +" mm.sce"), "CP_Misc", "", false, false);

    xYPlot_4.export(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Files\\CP_Misc - 0 - y = "+ -max_Misc +" mm mm.csv"), ",");
  ...
  xYPlot_4.setTitle("CP_Misc - y = "+ coordinate +" mm");
  
  xYPlot_4.encode(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Images\\CP_Misc - "+ i +" - y = "+ coordinate +" mm.png"), "png", 1920, 1080);

  xYPlot_4.exportScene(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Scenes\\CP_Misc - "+ i +" - y = "+ coordinate +" mm.sce"), "CP_Misc", "", false, false);

  xYPlot_4.export(resolvePath("..\\Post_Processing\\CP\\Misc\\Monitors\\Files\\CP_Misc - "+ i +" - y = "+ coordinate +" mm.csv"), ",");
}

  PlaneSection planeSection_5 = 
      (PlaneSection) simulation_0.getPartManager().createImplicitPart(new NeoObjectVector(new Object[] {}), new DoubleVector(new double[] {0.0, 0.0, 1.0}), new DoubleVector(new double[] {0.0, 0.0, 0.0}), 0, 1, new DoubleVector(new double[] {0.0}));

    planeSection_5.setPresentationName("CP_Misc2");
    ...
    xYPlot_5.setPresentationName("CP_Misc2");

    xYPlot_5.copyProperties(xYPlot_0);

    xYPlot_5.getParts().setObjects(planeSection_5);

    xYPlot_5.setTitle("CP_Misc - y = "+ -max_Misc2 +" mm");

    new File(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Scenes")).mkdirs();

    xYPlot_5.encode(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Images\\CP_Misc2 - 0 - y = "+ -max_Misc2 +" mm.png"), "png", 1920, 1080);

    xYPlot_5.exportScene(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Scenes\\CP_Misc2 - 0 - y = "+ -max_Misc2 +" mm.sce"), "CP_Misc2", "", false, false);

    xYPlot_5.export(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Files\\CP_Misc2 - 0 - y = "+ -max_Misc2 +" mm.csv"), ",");
  ...
  xYPlot_5.setTitle("CP_Misc - y = "+ coordinate +" mm");
  
  xYPlot_5.encode(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Images\\CP_Misc2 - "+ i +" - y = "+ coordinate +" mm.png"), "png", 1920, 1080);

  xYPlot_5.exportScene(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Scenes\\CP_Misc2 - "+ i +" - y = "+ coordinate +" mm.sce"), "CP_Misc2", "", false, false);

  xYPlot_5.export(resolvePath("..\\Post_Processing\\CP\\Misc2\\Monitors\\Files\\CP_Misc2 - "+ i +" - y = "+ coordinate +" mm.csv"), ",");
  }
}
      catch (Exception e){
